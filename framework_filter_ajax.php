...
function ajax_frameworks( $language ){
	switch ($language) {
                case "php":
                    echo '[ "opencart" , "expressionengine" , "symfony" , "laravel" , "magento" , "yii" , "cakephp" ,
 "moodle" , "phpbb", "symphony" , "joomla" , "wordpress" , "silverstripe" , "elgg" , "zf2" , "processwire" , "zend" , "mybb" ,
 "superboxselect" , "prestashop" , "drupal", "kohana" , "woocommerce" , "pfsense" , "codeigniter" , "nette" , "concret" , "aiki" ,
 "apigility" , "backdrop" , "bonita" , "fat-free" , "fuelphp" , "getsimple" , "gyroscope" , "hammerkit" , "horde" , "impresspages" ,
 "inek" , "jamroom" , "kajona" , "li3" , "novius os" , "phalcon" , "pop" , "prado" , "processwire" , "silex" , "smart" , "twistphp" ,
 "typo3" , "typo3 flow" , "xoops" ]';
                break;
                case "javascript":
			echo '["polymer" , "dojo toolkit" , "jquery" ,
 ...
 "rico" , "socket.io" , "spry" , "underscore.js" , "cascade" , "jquery mobile" , "mustache" , "jinja-js" , "twig.js" , "jasmine" , "mocha" , "qunit" , "tape" , "unit.js" , "angularjs" , "backbone.js" , "cappuccino" , "chaplin.js" , "echo" , "ember.js" , "enyo" , "ext js" , "google web toolkit" , "javascriptmvc" , "knockout" , "meteor" , "mojito" , "mootools" , "node.js" , "openui5sap" , "react" , "rialto" , "sproutcore" , "vue.js" , "wakanda" , "modernizr" , "cannon.js" , "mathjax"]';
                break;
                case "python":
                	echo '["bluebream" , "bottle" , "cherrypy" , "django" , "flask" , "grok" , "nagare" , "nevow" , "pylons" , 
 "pylons " , "pylons" , "pyramid" , "paste" , "quixote" , "rapidsms" , "tactic" , "tornado" , "turbogears" , "web2py" , "webware" , 
 "zope" , "zope 2"]';
		break;
                case "java":
                       echo '["flexive" , "jspx" , "openxava" , "crawler4j" , " nutch" , "hk2" , "dagger" , "appfuse" , "jlisa" ,
 ...
 "selenium" , "slf4j" , "slick2d" , "smack" , "sonarlint" , "sonarqube" , "jasper reports" , "spock" , "stormpath" ]';
                break;
                case "perl":
                    echo '["data::validator" , "params::util" , "params::validate" , "smart::args" , "audio::cd" , "audio::wav" ,
 ...
 "embperl" , "mason" , "web::scraper"]';
                break;
                case "ruby":
                	echo '["rails" , "rack" , "sinatra" , "hanami" , "padrino" , "cramp" , "cuba" , "pakyow" , "ramaze" , "raptor" , "hobo" , "scorched" , "merb-core" , "rango" , "plezi" , "strelka" , "camping" , "vanilla" , "bats" , "renee" , "harbor" , "gin" , "e" , "marley" , "lattice"]';
		break;
		case "c":
			echo '["libtool" , "meson" , "scons" , "zproject" , "mpl-2.0" , "ccache" , "clang" , "ncsa" , "distcc" , "firm" ,
...
if ( !isset($_GET['language']) )
	exit(" Missing programming language");
else{
	$l = strtolower(trim(strip_tags($_GET['language'])));
	ajax_frameworks( $l );
	//	echo PHP_EOL.$l;	//*** is the parameter OK
}
